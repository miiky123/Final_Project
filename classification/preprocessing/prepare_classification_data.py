...
Train/test splitting is handled in
``classification.preprocessing.split_classification_data``.
"""
...
CURATED_DATA_DIR = PROJECT_ROOT / "classification" / "data" / "curated"
...
def main():
    ...
    ap.add_argument(
        "--evaders",
        type=Path,
        default=CURATED_DATA_DIR / "efflux_evaders_om_corrected.pkl",
    )
    ap.add_argument(
        "--substrates",
        type=Path,
        default=CURATED_DATA_DIR / "efflux_substrates_om_corrected.pkl",
    )
    ap.add_argument(
        "--outpath",
        type=Path,
        default=CURATED_DATA_DIR / "prepared_bigdata.pkl",
    )
