...
PROCESSED_DATA_DIR = str(PROJECT_ROOT / "regression" / "data" / "processed")
REVIEW_DIR = str(PROJECT_ROOT / "regression" / "data" / "smiles_review")
TABLES = [1, 2, 3, 4]

# Prefer the table enriched with 3D descriptors if it exists.
INPUT_WITH_3D = os.path.join(PROCESSED_DATA_DIR, "tables1_4_with_3d.csv")
INPUT_BASE = os.path.join(PROCESSED_DATA_DIR, "tables1_4_consolidated.csv")
